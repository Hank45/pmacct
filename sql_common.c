...
int sql_evaluate_primitives(int primitive)
{
  ...
  if (config.sql_optimize_clauses) {
    ...
    if (config.what_to_count_2 & COUNT_SRC_HOST_LAT) what_to_count_2 |= COUNT_SRC_HOST_LAT;
    if (config.what_to_count_2 & COUNT_DST_HOST_LAT) what_to_count_2 |= COUNT_DST_HOST_LAT;
   if (config.what_to_count_2 & COUNT_SRC_HOST_LONG) what_to_count_2 |= COUNT_SRC_HOST_LONG;
    if (config.what_to_count_2 & COUNT_DST_HOST_LONG) what_to_count_2 |= COUNT_DST_HOST_LONG;
#
#endif
...
if (what_to_count_2 & COUNT_SRC_HOST_LAT) {
    if (primitive) {
      strncat(insert_clause, ", ", SPACELEFT(insert_clause));
      strncat(values[primitive].string, delim_buf, SPACELEFT(values[primitive].string));
      strncat(where[primitive].string, " AND ", SPACELEFT(where[primitive].string));
    }
    strncat(insert_clause, "ip_src_lat", SPACELEFT(insert_clause));
    strncat(values[primitive].string, "\'%s\'", SPACELEFT(values[primitive].string));
    strncat(where[primitive].string, "ip_src_lat=\'%s\'", SPACELEFT(where[primitive].string));
    values[primitive].type = where[primitive].type = COUNT_INT_SRC_HOST_LAT;
    values[primitive].handler = where[primitive].handler = count_src_host_lat_handler;
    primitive++;
  }
if (what_to_count_2 & COUNT_SRC_HOST_LONG) {
    if (primitive) {
      strncat(insert_clause, ", ", SPACELEFT(insert_clause));
      strncat(values[primitive].string, delim_buf, SPACELEFT(values[primitive].string));
      strncat(where[primitive].string, " AND ", SPACELEFT(where[primitive].string));
    }
    strncat(insert_clause, "ip_src_long", SPACELEFT(insert_clause));
    strncat(values[primitive].string, "\'%s\'", SPACELEFT(values[primitive].string));
    strncat(where[primitive].string, "ip_src_long=\'%s\'", SPACELEFT(where[primitive].string));
    values[primitive].type = where[primitive].type = COUNT_INT_SRC_HOST_LONG;
    values[primitive].handler = where[primitive].handler = count_src_host_long_handler;
    primitive++;
  }
  ...
  if (what_to_count_2 & COUNT_DST_HOST_LAT) {
    if (primitive) {
      strncat(insert_clause, ", ", SPACELEFT(insert_clause));
      strncat(values[primitive].string, delim_buf, SPACELEFT(values[primitive].string));
      strncat(where[primitive].string, " AND ", SPACELEFT(where[primitive].string));
    }
    strncat(insert_clause, "ip_dst_lat", SPACELEFT(insert_clause));
    strncat(values[primitive].string, "\'%s\'", SPACELEFT(values[primitive].string));
    strncat(where[primitive].string, "ip_dst_lat=\'%s\'", SPACELEFT(where[primitive].string));
    values[primitive].type = where[primitive].type = COUNT_INT_DST_HOST_LAT;
    values[primitive].handler = where[primitive].handler = count_dst_host_lat_handler;
    primitive++;
  }

  if (what_to_count_2 & COUNT_DST_HOST_LONG) {
    if (primitive) {
      strncat(insert_clause, ", ", SPACELEFT(insert_clause));
      strncat(values[primitive].string, delim_buf, SPACELEFT(values[primitive].string));
      strncat(where[primitive].string, " AND ", SPACELEFT(where[primitive].string));
    }
    strncat(insert_clause, "ip_dst_long", SPACELEFT(insert_clause));
    strncat(values[primitive].string, "\'%s\'", SPACELEFT(values[primitive].string));
    strncat(where[primitive].string, "ip_dst_long=\'%s\'", SPACELEFT(where[primitive].string));
    values[primitive].type = where[primitive].type = COUNT_INT_DST_HOST_LONG;
    values[primitive].handler = where[primitive].handler = count_dst_host_long_handler;
    primitive++;
  }
