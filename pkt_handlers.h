...
EXT void src_host_lat_geoipv2_handler(struct channels_list_entry *, struct packet_ptrs *, char **);
EXT void src_host_long_geoipv2_handler(struct channels_list_entry *, struct packet_ptrs *, char **);
EXT void dst_host_country_geoipv2_handler(struct channels_list_entry *, struct packet_ptrs *, char **);
EXT void dst_host_lat_geoipv2_handler(struct channels_list_entry *, struct packet_ptrs *, char **);
EXT void dst_host_long_geoipv2_handler(struct channels_list_entry *, struct packet_ptrs *, char **);
#endif
