...
#define COUNT_INT_SRC_HOST_LAT			0x0002000000080000ULL
#define COUNT_INT_SRC_HOST_LONG			0x0002000000100000ULL
#define COUNT_INT_DST_HOST_LAT			0x0002000000200000ULL
#define COUNT_INT_DST_HOST_LONG			0x0002000000400000ULL
...
#define COUNT_SRC_HOST_LAT		(COUNT_INT_SRC_HOST_LAT & COUNT_REGISTRY_MASK)
#define COUNT_SRC_HOST_LONG		(COUNT_INT_SRC_HOST_LONG & COUNT_REGISTRY_MASK)
#define COUNT_DST_HOST_COUNTRY		(COUNT_INT_DST_HOST_COUNTRY & COUNT_REGISTRY_MASK)
#define COUNT_DST_HOST_LAT		(COUNT_INT_DST_HOST_LAT & COUNT_REGISTRY_MASK)
#define COUNT_DST_HOST_LONG		(COUNT_INT_DST_HOST_LONG & COUNT_REGISTRY_MASK)
