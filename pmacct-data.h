...
static const struct _primitives_matrix_struct _primitives_matrix[] = {
  ...
  {"src_host_lat", 1, 1, 1, 1, 0, 0, 0, "Source IP address GeoIP resolution: latitude"},
  {"src_host_long", 1, 1, 1, 1, 0, 0, 0, "Source IP address GeoIP resolution: longitude"},
  {"dst_host_country", 1, 1, 1, 1, 0, 0, 0, "Destination IP address GeoIP resolution: country"},
  {"dst_host_lat", 1, 1, 1, 1, 0, 0, 0, "Destination IP address GeoIP resolution: latitude"},
  {"dst_host_long", 1, 1, 1, 1, 0, 0, 0, "Destination IP address GeoIP resolution: longitude"},
